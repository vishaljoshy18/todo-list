...
const projectDisplay = (function () {
	...
	const updateProjectToDisplay = function () {
		const projects = _projects__WEBPACK_IMPORTED_MODULE_0__.default.getProjects();
	...
	const _createTaskDiv = function (title, description, date, completionStatus) {
		...
		checkbox.addEventListener(
			...
			(e) => {
				...
				const activeProjectName = document.querySelector('#active-project').dataset.name;
				_projects__WEBPACK_IMPORTED_MODULE_0__.default.taskCompleted(e.target.parentNode.dataset.name, activeProjectName);
				checkbox.disabled = true;
			},
			{ once: true }
		);
...
const loadUI = function () {
	...
	_projects__WEBPACK_IMPORTED_MODULE_0__.default.getProjectFromLocalStorage();
